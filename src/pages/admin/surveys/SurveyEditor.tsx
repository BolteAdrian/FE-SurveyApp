    ...
    <div className="min-h-screen bg-[#111114] text-[#e8e6e1] flex flex-col lg:flex-row gap-8 p-4 md:p-8">
      ...
      <div className="w-full lg:w-80 space-y-6">
        ...
        <div className="space-y-4 bg-[#1e1e24]/50 p-4 rounded-xl lg:bg-transparent lg:p-0">
          <input
            className="w-full bg-[#1e1e24] border border-gray-800 p-3 rounded-lg outline-none focus:border-blue-500 transition-all"
            placeholder={t("SURVEY.TITLE")}
            value={title}
            onChange={(e) => setTitle(e.target.value)}
          />
          <textarea
            className="w-full bg-[#1e1e24] border border-gray-800 p-3 rounded-lg outline-none focus:border-blue-500 min-h-[100px]"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-1 gap-3">
          <button
            ...
            className="py-3 rounded-lg font-medium border border-gray-700 bg-[#1e1e24] text-white hover:bg-gray-800 disabled:opacity-50 transition-all"
          >
            {t("SURVEY.SAVE_DRAFT")}
          </button>
          <button
            ...
            disabled={loading || isSaveDisabled}
            className="py-3 rounded-lg font-bold bg-[#e9c46a] text-[#111114] hover:bg-[#dfb755] disabled:opacity-50 transition-all shadow-lg shadow-yellow-900/10"
          >
            {t("SURVEY.PUBLISH")}
          </button>
        </div>
                        ...
                        <div className="flex gap-3 md:gap-4">
                          ...
                          <div className="flex-1 space-y-3">
                            <div className="flex flex-col md:flex-row md:justify-between gap-4">
                              ...
                              {/* Action Buttons - Desktop version (hidden on mobile) */}
